<%@ Page Title="OSSAA.com" Language="C#" MasterPageFile="~/MobileSampleSite.master" AutoEventWireup="true" CodeFile="Ads.aspx.cs" Inherits="ResponsiveWebDesignOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <telerik:RadPageLayout ID="RadPageLayout1" runat="server" CssClass="t-rwd-tr t-rwd-overview" HtmlTag="None">
            <Rows>
                <telerik:LayoutRow style="text-align:center;" WrapperCssClass="t-rwd-gray-row" WrapperHtmlTag="Div" RowType="Container">
                    <Columns>
                        <telerik:LayoutColumn Span="12" SpanLg="12" SpanMd="12" SpanSm="12" SpanXl="12" SpanXs="12">
                            ...
                            <asp:Label runat="server" ID="lblPostponements" Font-Bold="true" ForeColor="#003399" Visible="false"></asp:Label>
                            <asp:UpdatePanel runat="server" UpdateMode="Always" Visible="false">
                                <ContentTemplate>
                                    ...
                                    <telerik:RadRotator RenderMode="Lightweight" ID="RadRotator3" runat="server" Width="925px" Height="55"
                                         ScrollDuration="300" FrameDuration="2000" ItemHeight="150"
                                        ItemWidth="185">
                                        <ItemTemplate>
                ...
                <telerik:LayoutRow WrapperCssClass="t-rwd-gray-row" WrapperHtmlTag="Div" RowType="Container" Visible="true">
                    <Columns>
                        <telerik:LayoutColumn Span="12">
                            <asp:HyperLink runat="server" BackColor="Red" NavigateUrl="FootballPlayoffs.aspx" Style="box-shadow: 0 5px 20px rgba(0, 0, 0, 1.5);">
                                <asp:Image runat="server" ID="ImageHeader" Style="box-shadow: 0 5px 20px rgba(0, 0, 0, 1.5); margin-top:20px;" Width="100%" ImageUrl="../images/Playoffs/OSSAAFootballPlayoffsW2.png"></asp:Image>
                            </asp:HyperLink>
                        </telerik:LayoutColumn>
                    </Columns>
                </telerik:LayoutRow>
                ...
                <telerik:LayoutRow WrapperCssClass="t-rwd-gray-row" WrapperHtmlTag="Div" RowType="Container">
                    <Columns>
                       ...
                       <telerik:LayoutColumn Span="4" CssClass="t-rwd-right">
                            <telerik:RadRotator ID="RadRotator2" runat="server" Width="300" Height="125px" ScrollDuration="2500" ScrollDirection="Left" FrameDuration="2000" ItemHeight="125" ItemWidth="300" Style="box-shadow: 0 5px 20px rgba(0, 0, 0, 1.5);" >
                                <Items>
                ...
                <telerik:LayoutRow WrapperCssClass="t-rwd-gray-row" WrapperHtmlTag="Div" RowType="Container">
                    <Columns>
                        ...
                        <telerik:LayoutColumn Span="4" SpanLg="4" SpanXl="4" SpanMd="4" SpanSm="12" SpanXs="12" CssClass="t-rwd-right" >
                            <div style="text-align:center;">
                            <asp:HyperLink runat="server" ID="hlAd1" ImageUrl="~/Images/Ads/Ad_Army_250x250.jpg" NavigateUrl="https://cicad.us/2XwwOmE" Target="_blank"  ></asp:HyperLink>
                            <asp:HyperLink runat="server" ID="hlAd2" ImageUrl="~/Images/Ads/Ad_Ford_250x250.jpg" NavigateUrl="http://buyfordnow.com" Target="_blank"  ></asp:HyperLink>

<%@ Page Title="OSSAA Constitution" Language="C#" MasterPageFile="~/MobileSampleSite.master" AutoEventWireup="true" CodeFile="Manual_Constitution.aspx.cs" Inherits="Manual_Constitution" %>
                ...
                <telerik:LayoutRow CssClass="t-rwd-row-pad">
                    <Columns>
                        <telerik:LayoutColumn Span="12" SpanLg="12" SpanXl="12" SpanMd="12" SpanSm="9" SpanXs="12">
                            ...
                            <asp:Label runat="server" ID="lblDownload" Text="To download a PDF, click the DOWN ARROW just to the upper/left of the document." ForeColor="Red"></asp:Label><br />
                            <div data-configid="26504309/66234518" style="width:100%; height:640px;" class="issuuembed"></div>

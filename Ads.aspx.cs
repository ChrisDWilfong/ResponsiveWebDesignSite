...
public partial class ResponsiveWebDesignOverview : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        **/
        ...
        /**
        Session["BootstrapScores"] = clsPageObjects.GetGamesList("BaseballFall", DateTime.Now.ToString("M/d/yyyy"));
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        if (RadRotator1.Visible)
            objWB1.BuildPageRotator("OSSAA.COM", "HomeScroller", ref RadRotator1);     /** CDW added 10/2/2019... **/

<%@ Page Title="OSSAA For the Parents" Language="C#" MasterPageFile="~/MobileSampleSite.master" AutoEventWireup="true" CodeFile="Parents.aspx.cs" Inherits="Parents" %>
            ...
            <Rows>
                ...
                <Columns>
                    <telerik:LayoutColumn Span="9" SpanXl="9" SpanLg="9" SpanMd="9" SpanSm="9" SpanXs="12" >
                        <asp:ImageButton runat="server" ID="ImageHeader" Style="box-shadow: 0 5px 20px rgba(0, 0, 0, 1.5); margin-top:20px;" Width="100%" ImageUrl="~/Images/media/OSSAASportHeaders_Parents.png"></asp:ImageButton><br /><br />
                   ...
                   <telerik:LayoutColumn Span="3" SpanXl="3" SpanLg="3" SpanMd="3" SpanSm="3" SpanXs="12" >
                            <div class="container">
                                <div class="centered">

...
public partial class Wrestling : System.Web.UI.Page
{
    public string pageSport = "Wrestling";
    public string pageWebType = "OSSAA.COM";

    protected void Page_Load(object sender, EventArgs e)
    {
        wrCounter.Text = Convert.ToString( SqlHelper.ExecuteScalar(SqlHelper.SQLConnectionOSSAA, System.Data.CommandType.Text, "SELECT intWomenWrestlers FROM adminSettings"));
    }
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        do
        {
            ...
            //        objNews.Items[x].Height = Unit.Pixel(80);
            //        break;
            //}
